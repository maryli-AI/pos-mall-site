...
const BRANDS = [
  ...
  { id: 'castles', name: 'Castles Technology', origin: 'Taiwan, China', blurb: 'Countertop, mobile and unattended payment terminals.' },
  { id: 'telpo', name: 'Telpo', origin: 'China', blurb: 'Android smart POS, self-service kiosks and biometric terminals.' },
  { id: 'imin', name: 'iMin', origin: 'China', blurb: 'Android desktop and mobile POS terminals.' },
  { id: 'diebold-nixdorf', name: 'Diebold Nixdorf', origin: 'USA', blurb: 'Retail checkout systems, self-service and payment hardware.' },
  { id: 'apg', name: 'APG', origin: 'USA', blurb: 'Cash drawers — the largest dedicated drawer manufacturer.' },
  { id: 'mmf', name: 'MMF', origin: 'Germany', blurb: 'Cash drawers and cash-handling accessories.' },
  { id: 'sato', name: 'SATO', origin: 'Japan', blurb: 'Industrial and desktop label and tag printers.' },
  { id: 'brother', name: 'Brother', origin: 'Japan', blurb: 'Desktop label printers and compact receipt printers.' },
  { id: 'godex', name: 'Godex', origin: 'Taiwan, China', blurb: 'Desktop and industrial barcode label printers.' },
  { id: 'argox', name: 'Argox', origin: 'Taiwan, China', blurb: 'Barcode label printers and scanners.' },
  { id: 'snbc', name: 'SNBC', origin: 'China', blurb: 'Receipt, label and kiosk printers at high volume.' },
  { id: 'hprt', name: 'HPRT', origin: 'China', blurb: 'Receipt and label printers for retail and logistics.' },
  { id: 'rongta', name: 'Rongta', origin: 'China', blurb: 'Entry to mid-range receipt and label printers.' },
  { id: 'gprinter', name: 'Gprinter', origin: 'China', blurb: 'Receipt and label printers, Bluetooth and Wi-Fi models.' },
  { id: 'postek', name: 'Postek', origin: 'China', blurb: 'Desktop and industrial barcode label printers.' },
  { id: 'opticon', name: 'Opticon', origin: 'Netherlands', blurb: 'Handheld and presentation barcode scanners.' },
  { id: 'unitech', name: 'Unitech', origin: 'Taiwan, China', blurb: 'Rugged handheld scanners and mobile computers.' },
  { id: 'cipherlab', name: 'CipherLab', origin: 'Taiwan, China', blurb: 'Barcode scanners and mobile data terminals.' },
];
